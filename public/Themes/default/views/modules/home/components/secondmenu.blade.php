                                ...
                                <div class="List List--full List--vertical List--separator List--separatorBrownMedium">
                                    ...
                                    <div class="List-item gutter-tiny gutter-vertical">
                                        <div class="gutter-vertical gutter-tiny">
                                            <a class="Link Link--block SiteNav-pageLink" href="/en-us/game/races"
                                                type="CATEGORY_ITEM" data-analytics="main-nav"
                                                data-analytics-placement="Game - Gameplay - Races"
                                                data-default-tabindex="0" tabindex="-1">Races</a>
                                        </div>
                                        <div class="gutter-vertical gutter-tiny">
                                            <a class="Link Link--block SiteNav-pageLink" href="/en-us/game/classes"
                                                type="CATEGORY_ITEM" data-analytics="main-nav"
                                                data-analytics-placement="Game - Gameplay - Classes"
                                                data-default-tabindex="0" tabindex="-1">Classes</a>
                                        </div>
                                        <div class="gutter-vertical gutter-tiny">
                                            <a class="Link Link--block SiteNav-pageLink"
                                                href="/en-us/game/talent-calculator" type="CATEGORY_ITEM"
                                                data-analytics="main-nav"
                                                data-analytics-placement="Game - Gameplay - Talent Calculator"
                                                data-default-tabindex="0" tabindex="-1">Talents</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="Dropdown SiteNav-doormat SiteNav-characterDropdown" name="SiteNav-user">
                    <div class="SiteNav-doormatContent">
                        <div class="List List--vertical List--right">
                            <div class="List-item">
                                <a class="SiteNav-pageLink" href="/en-us/logout" data-analytics="main-nav" data-analytics-placement="Community - Log Out" data-default-tabindex="0" tabindex="0">
